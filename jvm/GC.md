...
1.Serial收集器：单线程，STW，新生代收集:复制 老年代收集：标记整理 内存占用小，适合微服务

2.ParNew：多线程版本的Serial

3.Parallel Scavenge：目标是控制吞吐量，多线程，基于标记-复制

4.Serial Old：老年代版本的Serial

5.Parallel Old:老年代版本的Parallel Scavenge

6.CMS：目标是停顿时间最短，基于标记-清除算法，运行过程分为四个步骤
